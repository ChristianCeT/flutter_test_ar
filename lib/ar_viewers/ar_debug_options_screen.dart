...
class ARDebugOptionsScreen extends StatefulWidget {
  const ARDebugOptionsScreen({Key? key}) : super(key: key);

  @override
  State<ARDebugOptionsScreen> createState() => _ARDebugOptionsScreenState();
}

class _ARDebugOptionsScreenState extends State<ARDebugOptionsScreen> {
  ...
  final String _planeTexturePath = "assets/triangle.png";
